...
pos_pre='raw.githubusercontent.com/saeedeh/sensoryValence-onlineStudy/main/stimuli/pos-upright/'
pos_urls=[pos_pre+s for s in pos_img]

neg_pre='raw.githubusercontent.com/saeedeh/sensoryValence-onlineStudy/main/stimuli/neg-upright/'
...
for i in range(N):
    outFile=os.path.join(os.getcwd(),'splits-upright','split'+str(N),'chunk'+str(i+1)+'.csv' )
